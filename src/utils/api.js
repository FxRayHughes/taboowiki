...
const STATUS = 'public'; // 'public' or 'dev'
...
export const getFrontendBaseUrl = () => {
    if (STATUS === 'public') {
        return 'https://taboowiki.maplex.top';
    }
    if (STATUS === 'dev') {
...
// GITHUB 鉴权Key
export const getGitHubOAuthKey = () => {
    if (STATUS === 'public') {
        return 'Ov23li2MIRnkuL9KBrac';
    }
    if (STATUS === 'dev') {
        return 'Ov23li76llz9CJU36Kjs';
    }
    return 'Ov23li2MIRnkuL9KBrac';
}
// 资源地址
export const getFileBedUrl = () => {
    return 'https://openlist.maplex.top';
}
